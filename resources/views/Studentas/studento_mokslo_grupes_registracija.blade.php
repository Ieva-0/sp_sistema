...
<div class="align-middle">
    <h3 style="text-align: center">Projektai</h3>
...
<div class="content">
    ...
    <h3 style="padding-bottom: 20px">Studento informacija</h3>
    <form>
        ...
        <div class="form-group" style="width: 18%">
            <label for="exampleFormControlInput1">Mokslo grupės studento vardas pavardė</label>
            <input type="vardasPavarde" class="form-control" id="exampleFormControlInput1" placeholder="Vardas Pavardė">
        </div>
